...
class favoritenotes extends StatefulWidget {
  favoritenotes({Key? key}) : super(key: key);
                  ...
                  itemBuilder: ((context, index) {
                    return Container(
                      ...
                      child: SingleChildScrollView(
                        child: Column(
                          children: [
                            if (tumnotlar![index].kategoriId == 2)
                           Notlar(index,Colors.green, tumnotlar,tumnotlar![index]),
                          ],
                        ),
                      ),
                    );
          ...
          child: GestureDetector(
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                    builder: (context) => NotDetay(color, not, i, tumnotlar,1))).then((_) => setState(() {}));
                                    ...
                                    if (silinenId != 0) {
                                      ...
                                      ScaffoldMessenger.of(context).showSnackBar(
                                        SnackBar(
                                          ...
                                          content: Container(height: 20,color: color,child: Text("Note Deleted")),
